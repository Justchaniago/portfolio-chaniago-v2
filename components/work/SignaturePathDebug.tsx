  ...
  return (
    <div
      style={{
        ...
        zIndex: 99999,
        pointerEvents: 'none',
        boxShadow: '0 8px 32px rgba(33, 68, 255, 0.15)',
        width: '260px',
        display: 'flex',
    ...
    >
      <div style={{ fontWeight: 800, color: '#2144FF', letterSpacing: '0.05em', borderBottom: '1px solid rgba(255, 255, 255, 0.15)', paddingBottom: '6px', textTransform: 'uppercase' }}>
        Path Debug HUD
      </div>
      <div>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
          <span>Progress:</span>
          <span style={{ color: '#2144FF', fontWeight: 'bold' }}>{Math.round(data.progress * 100)}%</span>
        </div>
        <div style={{ color: '#2144FF', letterSpacing: '0.05em' }}>
          [{progressBar}]
        </div>
      </div>
